...
- [`fast.drawio`](https://app.diagrams.net/#Hguilhermelinosp%2Ffast-drawio%2Fmain%2Ffast.drawio#%7B%22pageId%22%3A%22architecture-general%22%7D): diagrama editável que representa a arquitetura completa do sistema em todas as etapas.
...
Também é possível abrir o arquivo diretamente pelo recurso **Open Existing Diagram** do app.diagrams.net.
...
- Manter alinhamento, espaçamento e direção de leitura coerentes.
- Usar cores e formas com significado consistente; evitar decoração que não comunique informação.
- Conectar elementos apenas quando a relação for relevante e manter setas/legendas legíveis.
- Revisar o diagrama no app.diagrams.net antes de publicar alterações.
- Descrever no commit o que mudou e, quando aplicável, indicar quais páginas ou áreas foram afetadas.

Estas convenções são iniciais e podem evoluir conforme o repositório ganhar novos diagramas e colaboradores.

## Contribuição

Consulte [`CONTRIBUTING.md`](./CONTRIBUTING.md) para o fluxo de contribuição e os passos de validação.
